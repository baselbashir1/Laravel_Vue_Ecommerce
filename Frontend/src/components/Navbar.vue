                ...
                <MenuItems
                    ...
                    <div class="px-1 py-1">
                        ...
                        <button :class="[
                            ...
                            <UserIcon :active="active" class="mr-2 h-5 w-5 text-indigo-400" aria-hidden="true" /> Profile
                        </button>
                        </MenuItem>
                        <MenuItem v-slot="{ active }">
                        <button @click="logout" :class="[
                            ...
                            <LogoutIcon :active="active" class="mr-2 h-5 w-5 text-indigo-400" aria-hidden="true" /> Logout
                        </button>
                        </MenuItem>
                    </div>
                </MenuItems>
...
<script setup>
import { MailIcon, LogoutIcon, UserIcon } from '@heroicons/vue/outline';
...
const currentUser = computed(() => store.state.user.date);
